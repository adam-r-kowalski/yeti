...
fn wasmStringInstruction(string: *WasmString, wasm_instruction: Entity) !void {
    switch (wasm_instruction.get(components.WasmInstructionKind)) {
        ...
        .i64_le => try string.appendSlice("\n    (i64.le_s)"),
        .i32_le => try string.appendSlice("\n    (i32.le_s)"),
        .u64_le => try string.appendSlice("\n    (i64.le_u)"),
        .u32_le => try string.appendSlice("\n    (i32.le_u)"),
        .f64_le => try string.appendSlice("\n    (f64.le)"),
        .f32_le => try string.appendSlice("\n    (f32.le)"),
        .i64_gt => try string.appendSlice("\n    (i64.gt_s)"),
        .i32_gt => try string.appendSlice("\n    (i32.gt_s)"),
        .u64_gt => try string.appendSlice("\n    (i64.gt_u)"),
        .u32_gt => try string.appendSlice("\n    (i32.gt_u)"),
        .f64_gt => try string.appendSlice("\n    (f64.gt)"),
        .f32_gt => try string.appendSlice("\n    (f32.gt)"),
        .i64_ge => try string.appendSlice("\n    (i64.ge_s)"),
        .i32_ge => try string.appendSlice("\n    (i32.ge_s)"),
        .u64_ge => try string.appendSlice("\n    (i64.ge_u)"),
        .u32_ge => try string.appendSlice("\n    (i32.ge_u)"),
        .f64_ge => try string.appendSlice("\n    (f64.ge)"),
        .f32_ge => try string.appendSlice("\n    (f32.ge)"),
        .i64_eq => try string.appendSlice("\n    (i64.eq)"),
        .i32_eq => try string.appendSlice("\n    (i32.eq)"),
        .f64_eq => try string.appendSlice("\n    (f64.eq)"),
        .f32_eq => try string.appendSlice("\n    (f32.eq)"),
        .i64_ne => try string.appendSlice("\n    (i64.ne)"),
        .i32_ne => try string.appendSlice("\n    (i32.ne)"),
        .f64_ne => try string.appendSlice("\n    (f64.ne)"),
        .f32_ne => try string.appendSlice("\n    (f32.ne)"),
        .i64_or => try string.appendSlice("\n    (i64.or)"),
        .i32_or => try string.appendSlice("\n    (i32.or)"),
        .i64_and => try string.appendSlice("\n    (i64.and)"),
        .i32_and => try string.appendSlice("\n    (i32.and)"),
        .i64_shl => try string.appendSlice("\n    (i64.shl)"),
        .i32_shl => try string.appendSlice("\n    (i32.shl)"),
        .u64_shl => try string.appendSlice("\n    (i64.shl)"),
        .u32_shl => try string.appendSlice("\n    (i32.shl)"),
        .i64_shr => try string.appendSlice("\n    (i64.shr_s)"),
        .i32_shr => try string.appendSlice("\n    (i32.shr_s)"),
        .u64_shr => try string.appendSlice("\n    (i64.shr_u)"),
        .u32_shr => try string.appendSlice("\n    (i32.shr_u)"),
        .i64_rem => try string.appendSlice("\n    (i64.rem_s)"),
        .i32_rem => try string.appendSlice("\n    (i32.rem_s)"),
        .u64_rem => try string.appendSlice("\n    (i64.rem_u)"),
        .u32_rem => try string.appendSlice("\n    (i32.rem_u)"),
        .i64_xor => try string.appendSlice("\n    (i64.xor)"),
        .i32_xor => try string.appendSlice("\n    (i32.xor)"),
        .call => {
            try string.appendSlice("\n    (call $");
